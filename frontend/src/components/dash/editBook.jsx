...
// import NoImageSelected from "../../assets/images/no-image-selected.jpg";

function EditBook() {
  const navigate = useNavigate();
  const urlSlug = useParams();
  const baseUrl = `http://localhost:3001/api/books/${urlSlug.slug}`;
        ...
        <form className="bookdetails" onSubmit={createBook}>
          <div className="col-1">
            ...
            {image ? (
              ...
              <img
                src={`http://localhost:3001/uploads/${thumbnail}`}
                alt="preview image"
              />
            )}
            <input
